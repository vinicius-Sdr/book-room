...
public record QuartoRequest(Long idPredio, Long idLocalidade, Long idTipo, String identicacao, Integer totalPessoas,
	...
	public Quarto fromQuartoDto() {
		...
		return new Quarto(null, new Predio(idPredio), new Localidade(idLocalidade), identicacao, totalPessoas,
				new Tipo(idTipo), valorDiaria, quantidadeQuartos);
	}
}
