...
public interface PredioControllerSwagger {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "201", description = "Recurso criado com sucesso"),
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Lista com todos os Prédios cadastrados"),
			@ApiResponse(responseCode = "500", description = "Erro interno no servidor") })
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Recurso recuperado com sucesso"),
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Recurso alterado com sucesso"),
			@ApiResponse(responseCode = "400", description = "Solicitação inválida"),
			@ApiResponse(responseCode = "404", description = "Recurso não encontrado"),
			@ApiResponse(responseCode = "500", description = "Erro interno no servidor") })
