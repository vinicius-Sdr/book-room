...
(
    ...
    id_localidade  INTEGER REFERENCES book_room_quarto.localidade (id) NOT NULL, -- LocalidadeEntity a qual o prédio pertence
...
COMMENT ON COLUMN book_room_quarto.predio.id_localidade IS 'LocalidadeEntity a qual o prédio pertence';
...
COMMENT ON COLUMN book_room_quarto.quarto.id_localidade IS 'LocalidadeEntity na qual o quarto está situado';
COMMENT ON COLUMN book_room_quarto.quarto.tipo IS 'TipoEntity do quarto';
...
COMMENT ON COLUMN book_room_quarto.quarto_itens.tipo_item IS 'TipoEntity de item presente no quarto';
...
COMMENT ON COLUMN book_room_quarto.quarto_camas.tipo_cama IS 'TipoEntity de cama';
...
COMMENT ON COLUMN book_room_quarto.amenidades.id IS 'Identificador único da amenidadeEntity';
COMMENT ON COLUMN book_room_quarto.amenidades.descricao IS 'Descrição da amenidadeEntity';
...
(
    ...
    id_amenidade   INTEGER REFERENCES book_room_quarto.amenidades (id) NOT NULL, -- Identificador da amenidadeEntity
    quantidade     INTEGER                                             NOT NULL, -- Quantidade da amenidadeEntity na localidade
    data_inclusao  TIMESTAMP DEFAULT CURRENT_TIMESTAMP,                          -- Data e hora de inclusão do registro
    data_alteracao TIMESTAMP DEFAULT CURRENT_TIMESTAMP,                          -- Data e hora da última alteração do registro
...
COMMENT ON COLUMN book_room_quarto.amenidades_localidade.id_amenidade IS 'Identificador da amenidadeEntity';
COMMENT ON COLUMN book_room_quarto.amenidades_localidade.quantidade IS 'Quantidade da amenidadeEntity na localidade';
